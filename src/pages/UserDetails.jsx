    ...
    <div className='details container'>
        <div className="details__right">
            <div className="details__avatar">
                <img src={user.avatar_url} alt="avatar" className="details__img" />
            </div>
        ...
        <div className="details__left">
            ...
            <div className="details__info">
                ...
                <p className="details__update"><span>Updated date: </span> {user.updated_at}</p>
                {user.company && (
                ...
                {user.twitter_username && (
                    <p className="details__status"><span>Twitter: </span> <a href={`https://twitter.com/${user.twitter_username}`}>{user.twitter_username}</a></p>
                )}
                {user.type && (
